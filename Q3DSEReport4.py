...
#notes1 = "Likely local noise at +2086s. Refer to Spectrogram."     #edit as required - This overwrites the previous line!
notes2 = ""
...
fig.text(0.95, 0.92, 'Oberon Citizen Science Network', size = 'x-small', ha = 'right')
fig.text(0.98, 0.845, '#ShakeNet', ha='right',size='small')
fig.text(0.98, 0.875, '@raspishake', ha='right',size='small')
fig.text(0.98, 0.905, '@AlanSheehan18', ha='right',size='small')
fig.text(0.98, 0.86, '@matplotlib', ha='right',size='small')
fig.text(0.98, 0.815, '#Python', ha='right',size='small')
fig.text(0.98, 0.89, '#CitizenScience', ha='right',size='small')
fig.text(0.98, 0.8, '#Obspy', ha='right',size='small')
fig.text(0.98, 0.83, '#Cartopy', ha='right',size='small')
...
# plot logos
pics = "D:/Pictures/Raspberry Shake and Boom/2025/"
...
if allphases or (lovet >= delay and lovet <= (delay+duration)):
    y2 -= 2*dy
    fig.text(0.625, y2, 'Love', size='xx-small')
    y2 -= dy
    fig.text(0.625, y2, 'Surface Wave: '+str(round(lovet,1))+'s:', size='xx-small')
...
print('M'+str(mag)+' #earthquake '+locE+' detected on Raspberry Shake 3D (AM.'+stn+'.00.EH(ZNE)) @raspishake #python #CitizenScience #ShakeNet #Obspy @matplotlib #Cartopy #seismology #OCSN')
