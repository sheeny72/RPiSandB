...
fig.text(0.98, 0.905, '@raspishake', ha='right')
fig.text(0.98, 0.89, '@AlanSheehan18', ha='right')  #Twitter Handle  **** Enter data****
fig.text(0.98, 0.875, '@matplotlib', ha='right')
