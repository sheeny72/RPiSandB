...
# Setup the data plot
delay = 0                  # delay the start of the plot from the event **** Enter data****
duration = 200                  # duration of plots **** Enter data****

notes1 = ""                       # add notes to the diagram. max one \n per note.
notes2 = ""
notes3 = ""
psd = False         # True to plot PSD, False to plot FFT **** Enter data****

# set up the traces and ray paths
plot_envelopes = True          # plot envelopes on traces
allphases = False   # true if all phases to be plotted, otherwise only those in the plotted time window are plotted **** Enter data****
