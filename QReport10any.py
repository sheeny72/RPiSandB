...
#enter event data
eventTime = UTCDateTime(2023, 6, 11, 13, 8, 47) # (YYYY, m, d, H, M, S) **** Enter data****
latE = -56.9                                    # quake latitude + N -S **** Enter data****
lonE = 147.6                                    # quake longitude + E - W **** Enter data****
depth = 10                             # quake depth, km **** Enter data****
mag = 5.8                              # quake magnitude **** Enter data****
eventID = 'rs2023lkobla'               # ID for the event **** Enter data****
...
#notes1 = "Likely local noise at +1255s. Refer to Spectrogram."     #edit as required - This overwrites the previous line!
notes2 = ""
notes3 = ""
...
#set up the map
sat_height = 100000000.0   # adjust satellite height for desire view on map **** Enter data****
lat_correction = 0              # correction in latutude for large distances **** Enter data****
...
ax5 = fig.add_subplot(6,2,11)           # PSD
